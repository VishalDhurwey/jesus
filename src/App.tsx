...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-green-500 font-mono flex flex-col">
      {/* Header Section */}
      <header className="py-4 px-4 md:px-16 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div className="flex flex-col justify-center space-y-2 text-center md:text-left">
          ...
          <p className="text-green-400 opacity-75 text-sm md:text-base">Seek wisdom through digital revelation</p>
        </div>
        <div className="flex items-center space-x-2 w-full md:w-auto justify-center md:justify-end">
          ...
          <div className="flex items-center space-x-2 truncate">
            <span className="text-green-400">0x1234567890abcdef</span>
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 p-2 md:p-10 gap-4">
        {/* Left side: Glitch Art */}
        <div className="flex justify-center">
          <div className="w-full max-w-full h-48 sm:h-64 md:h-72">
            <GlitchAsciiArt />
          </div>
        </div>
        ...
        <div className="flex flex-col space-y-4">
          <div className="bg-gray-900 rounded-lg p-4 w-full h-[250px] sm:h-[350px] md:h-[450px] lg:h-[500px] xl:h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-green-500 scrollbar-track-gray-800">
            <div className="space-y-4">
              {messages.map((user_query, index) => (
                <div key={index} className={`flex ${user_query.isBot ? 'justify-start' : 'justify-end'}`}>
                  <div
                    className={`flex items-start space-x-2 max-w-[90%] sm:max-w-[80%] md:max-w-[70%] ${
                  ...
                  >
                    ...
                    <div className={`p-3 rounded ${user_query.isBot ? 'bg-gray-800' : 'bg-gray-700'}`}>
      ...
      <footer className="bg-gray-900 py-4 border-t border-green-600 mt-auto px-4 md:px-16 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <p className="text-green-400 opacity-75 text-sm sm:text-base text-center md:text-left">
